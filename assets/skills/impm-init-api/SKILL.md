...
### Step 4.1: generate the OpenAPI 3.0 JSON
Based on the API Markdown document generated in Step 3, convert it to an OpenAPI 3.0 format JSON file docs/{project English abbreviation}-v0.0.1/openapi-v0.0.1.json:
1. **Basic structure**:
```json
{
  "openapi": "3.0.3",
...
3. **Numbering rule**: during the initialization phase, number starting from API-001 in the format API-{sequence}.
...
### Step 4.2: generate the Swagger UI HTML
Generate the version-level Swagger UI entry file docs/{project English abbreviation}-v0.0.1/index.html per the following template:
```html
<!DOCTYPE html>
<html>
<head>
  <title>{project name} API Documentation - v0.0.1</title>
  <link rel="stylesheet" href="https://unpkg.com/swagger-ui-dist/swagger-ui.css">
</head>
<body>
  <h1>{project name} API Documentation - v0.0.1</h1>
...
- docs/{project English abbreviation}-v0.0.1/openapi-v0.0.1.json (OpenAPI 3.0 format)
- docs/{project English abbreviation}-v0.0.1/index.html (Swagger UI entry)
