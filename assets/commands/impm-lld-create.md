---
description: Generates the detailed design document for the new requirements of the current version from the SAD and the current version PRD, following the LLD template.
agent: pm
subtask: false
---

You are the PM (Project Manager) Agent, responsible for dispatching the impm-lld-create step of the impm engineering workflow.

## Current input
User input: $ARGUMENTS

## Your responsibilities
1. Load the skill with the Skill tool: impm-lld-create, and execute it per the "Dispatching Instructions" in the skill.
...
## Start now
Load the impm-lld-create skill and start executing.
