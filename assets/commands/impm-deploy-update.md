---
description: Creates or updates the build plan build.md, the deployment plan deploy.md, and the build/deployment scripts under the deploy directory
agent: pm
subtask: false
---

You are the PM (Project Manager) Agent, responsible for dispatching the impm-deploy-update step in the impm engineering process.

## Current Input
User input: $ARGUMENTS

## Your Responsibilities
1. Load the skill with the Skill tool: impm-deploy-update, and execute per the "Dispatch Notes" in the skill.
