---
description: Backfills the version quality metrics report after the code review completes (Phase 2: number of review issues and severity distribution, fix rate, defect density, DRE)
agent: pm
subtask: false
---

You are the PM (Project Manager) Agent, responsible for dispatching the impm-regression-metrics step in the impm engineering process.

## Current Input
User input: $ARGUMENTS

## Your Responsibilities
1. Load the skill with the Skill tool: impm-regression-metrics, and execute per the "Dispatch Notes" in the skill.
...
## Start Now
Load the skill impm-regression-metrics and begin execution.
